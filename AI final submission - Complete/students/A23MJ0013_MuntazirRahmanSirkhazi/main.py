...
class SoilData:
    ...
    def get_current_metrics():
        return {
            ...
            'nitrogen': {'value': 30, 'optimal': '40 - 60 ppm', 'status': 'alert'},
        ...
        <div class="logic-dropdown" style="margin: 15px 0; border-color: #2196f3;">
            ...
            <div class="dropdown-content" id="multi-param-logic">
                ...
                <div class="calculation-step">
                    ...
                    <div class="formula-box">
                        Alerts: <span class="highlight-value">1</span><br>
                        Warnings: <span class="highlight-value">1</span> (Phosphorus)<br>
                        Optimal: <span class="highlight-value">4</span><br>
                        <br>
                        Since alerts = 1 AND warnings = 1:<br>
                ...
                <div class="formula-box" style="background: #e3f2fd; border-left-color: #2196f3;">
                    ...
                    • 5 parameters are optimal (66.8%)<br>
                    • 1 parameter needs attention (13.3%)<br>
                    • 1 critical issues(16.7%)<br>
                    <br>
